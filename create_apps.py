...
# apps_names = ['category', 'subcategory', 'service', 'payment', 'professional', 'employee', 'invoice', 'image', 'customer', 'authentication', 'users']  # Lista de nomes de aplicativos
apps_names = ['polimorph', 'finance', 'reports', 'sales', 'person']  # Lista de nomes de aplicativos
