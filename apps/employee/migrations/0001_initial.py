    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advanced_value', models.DecimalField(decimal_places=2, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('overtime_hourly_rate', models.DecimalField(decimal_places=2, max_digits=10)),
                ('total_overtime_hours', models.DecimalField(decimal_places=2, max_digits=5)),
                ('overtime_value', models.DecimalField(decimal_places=2, max_digits=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
